...
#title = plt.title("\n".join(wrap("Minimum Number of Doses after Changing Fraction Size (Gy) and Initial PSI to Achieve LRC", 60)), 
          #fontsize = 20)
#title = plt.title("\n".join(wrap("Effect of Changing Fraction Size (Gy) on Number of Fractions", 60)), fontsize = 20)
#title.set_y(5)
...
fig34.set_size_inches(6.8, 5, forward = True)
plt.tight_layout()
plt.show()