...
# c = [0 for i in range(int(len(frac_size) / 2))] +
#     [1 for j in range(int(len(frac_size) / 2))]
...
plt.title('Fraction Size vs. Initial Proliferation Saturation to Reach ' +
          '32.2% Threshold Following RT for ' +
          r'$\alpha$' + " = " + str(alpha[0]), fontsize=20)
