...
plt.vlines(max(x), 0, ymax, linestyles = 'dotted', color = 'black', linewidth = 5, zorder=3)
plt.hlines((1 - threshold) * 100,0, xmax, colors = 'k', linestyles = 'dotted', color = 'black', linewidth = 5, zorder=3)
